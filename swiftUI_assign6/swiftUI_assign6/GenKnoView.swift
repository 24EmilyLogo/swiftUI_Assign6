...
struct GenKnoView: View {
        ...
        ZStack {
            ...
            VStack {
                ...
                VStack {
                    ...
                    ForEach(question.ansOpts.indices){ index in AnsOpts(buttonText: question.ansOpts[index]){
                        uGuess = index
                    }
    ...
    func nextQ() {
        ...
        // Reset current question index if all questions have been answered
                if currentQIndex >= Question.allQs.count {
                    currentQIndex = 0
                }
    }
    ...
    func colorButt(at buttIndex: Int) -> Color{
        ...
        if uGuess == question.corAnsIndex{
...
#Preview {
    //the Question model needed to be called in the view here and on Content View
